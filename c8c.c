        ...
        if(p->opr.oper == INT)
            ...
            exit(-1);
                ...
                switch(p->opr.op[0]->type){
                    ...
                    case typeId://A variable
                        ...
                        //insertSymbol(p->opr.op[0]->id.i,type,1,size);//name type dimesion size
            ...
            int tempsize;
                        ...
                        /*for(i = 0;i < p->opr.op[0]->arr.dimension; i++){
                            ...
                            tempsize = inter(p->opr.op[0]->arr.index[i]);
                ...
                printf("Compile Error(1051): size of array can not be negative.\n");
                    ...
                    exit(-1);
                        ...
                        insertSymbol(p->opr.op[0]->arr.id, type, p->opr.op[0]->arr.dimension, size);//last parameter: size*/
...
bool insertSymbol(char * name, SymbolType type, int dimension, int *size){
    ...
    int j = 0;
/**
 * insertsymboldriver has done size check
 */
    ...
    /*for(i = 0;i < dimension;i++){
...

        {
            ...
            printf("Compile Error(1050): Variable size can not be zero or negative.\n");
